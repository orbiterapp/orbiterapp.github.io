    ...
    async function upsert(t) {
      if (!navigator.onLine) { _queueOffline({ type: 'upsert', task: t }); return; }
    ...
    async function patch(id, fields) {
      if (!navigator.onLine) { _queueOffline({ type: 'patch', id: id, fields: fields }); return; }
    ...
    async function deleteTask(id) {
      if (!navigator.onLine) { _queueOffline({ type: 'delete', id: id }); return; }
