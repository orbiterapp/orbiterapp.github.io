    ...
    async function upsert(t) {
      var payload = { id: t.id, user_id: t.user_id, title: t.title, notes: t.notes || '', due_date: t.due_date || null, defer_date: t.defer_date || null, is_completed: t.is_completed || false, is_flagged: t.is_flagged || false, priority: t.priority || 'None', energy_level: t.energy_level || 'None', project_id: t.project_id || null, tag_ids: t.tag_ids || '[]', created_at: t.created_at, completed_at: t.completed_at || null, repeat_rule: t.repeat_rule || 'None', parent_id: t.parent_id || null, sort_order: t.sort_order || 0, last_reviewed: t.last_reviewed || null, next_review_date: t.next_review_date || null, review_frequency_num: t.review_frequency_num || null, review_frequency_unit: t.review_frequency_unit || null, is_in_review: t.is_in_review || false, is_today_task: t.is_today_task || false, is_evening_task: t.is_evening_task || false, notify_before_minutes: t.notify_before_minutes !== undefined ? t.notify_before_minutes : 30, updated_at: t.updated_at };
